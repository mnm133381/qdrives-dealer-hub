        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ width: '100%' }}>
          <View style={[styles.card, danger && styles.cardDanger]}>
            ...
            <TouchableOpacity
              ...
              onPress={submit}
              style={[styles.cta, danger && styles.ctaDanger, (!reason.trim() || busy) && { opacity: 0.4 }]}
...
const styles = StyleSheet.create({
  ...
  input: { color: colors.textPrimary, fontSize: 13, fontWeight: '500', minHeight: 70, padding: 12, backgroundColor: colors.bgCard, borderColor: colors.border, borderWidth: 1, borderRadius: radii.md, textAlignVertical: 'top', marginBottom: 14 },
